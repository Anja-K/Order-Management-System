$(document).ready(function() {
            ...
            $('#customer').on('change paste keyup', function(){
                ...
                //Read customer infromation from database
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        // Update form inputs when selecting a customer from the dropdown
            ...
            //Update input information every time the user changes quantity value
